/**
 * KaspaLoader - A standalone module for displaying a Kaspa loading screen
 * 
 * Usage:
 * 1. Add this module to your project
 * 2. Initialize in dashboard.js after DOM loads
 * 3. Call KaspaLoader.show() before loading operations
 * 4. Call KaspaLoader.hide() when loading completes
 */

const KaspaLoader = (function() {
  ...
  const createLoader = () => {
    ...
    container.style.backgroundColor = config.showBackground ? `rgba(255, 255, 255, ${config.backgroundOpacity})` : 'transparent';
  ...
  return {
    ...
    show: () => {
      ...
      let loader = document.getElementById('kaspa-loader-container');
...
window.KaspaLoader = KaspaLoader;
